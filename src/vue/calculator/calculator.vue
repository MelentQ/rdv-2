    ...
    <div class="page-bg page-bg--grey legacy-calculator" >
            ...
            <div class="section__container">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-7 col-xl-7">
                        ...
                        <div class="col">
                            <div class="v-indent v-indent--green t-base t-base--size--h4 t-base--color--blue-dark">Рассчитайте стоимость интеграции 1С с маркетплейсами<br/>
                              Выберите одну или несколько схем работы</div>
                        </div>
                    </div>
                        <div class="row section__block d-flex flex-wrap calculator__tarif-list" :class="priorityItem">
                            <div class="col-12 col-sm-auto col-xl-4 d-flex justify-content-center col--gap--20 v-indent v-indent--yellow-last calculator__product-item" :class="item.product" v-for="item in marketplaces">
                                <div class="card">
                                    ...
                                    <ul>
                                        <li class="v-indent v-indent--red" v-for="tarif in item.tarifs">
                                            <div class="schem-item" @click="activateTarif(tarif)" :class="{ 'is-active': tarif.isActive, 'is-ozon': tarif.isOzonFBO }">
                                                <div class="t-base t-base--size--small t-base--weight--bold text-uppercase t-base--color--dark-light">{{tarif.code}}
                                                  <div class="scheme-tip-content">
                                                    <img src="assets/include/assets/img/svg/info_circle.svg" alt="information">
                                                    <div class="schem-tip">Данная схема доступна к покупке при одновременном приобретении тарифа Ozon FBS или Wildberries FBM</div>
                                                  </div>
                                                </div>
                                                <div class="t-base t-base--size--small t-base--color--gray-dark"><span>{{tarif.price | localStr}}</span>&nbsp;<span>₽/день</span></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row section__block">
                            <div class="v-indent v-indent--green t-base t-base--size--h4 t-base--color--blue-dark">Выберите количество лицензий 1С</div>
                            <div class="col-12">
                                <div class="card card--full card--p20" :class="{ 'is-active': licenseCounter&gt;0 }">
                                    <div class="d-sm-flex d-block justify-content-between">
                                        <div class="v-indent v-indent--red t-base t-base--weight--bold t-base--color--dark-light">Пользовательские лицензии 1С</div>
                                        <div class="v-indent v-indent--red-last t-base t-base--size--small t-base--color--gray-dark"><span>{{licensePrice | localStr}}</span>&nbsp;<span>₽/день за одну лицензию</span></div>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6 col-xl-6 d-flex justify-content-center col--gap--20 v-indent v-indent--yellow-last" v-for="item in modules">
                                <div class="card card--full card--p20 d-flex flex-column justify-content-between" :class="{ 'is-active': item.isActive }">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="info" @click="showModal" :id="item.id"><img src="assets/include/assets/img/information.svg" alt="information">
                    ...
                    <div id="mobilePriceCalc" class="col-12 col-md-12 col-lg-5 col-xl-5 col--mobile-no-padding col--styky-block sidebar">
                                ...
                                <div class="card card--lr-40 card--medium card--bg-blue-light sidebar__content">
                                    ...
                                    <div class="v-indent v-indent--green">
                                        <div class="d-flex justify-content-center align-items-center" v-if="activeDays.discount > 0">
                                            <div class="t-base t-base--line--through t-base--align--center t-base--weight--bold t-base--color--white-main">{{allPrice | localStr}} ₽</div>
                                            <div class="label-sale">
                                                <div class="t-base t-base--size--small t-base--weight--bold t-base--color--blue-light">-{{activeDays.discount}}%</div>
                                            </div>
                                        </div>
                                        <div class="t-base--align--center t-base t-base--size--h2 t-base--color--yellow-main">{{allPriceDiscount | localStr}} ₽</div>
                                        <div class="t-base t-base--size--small t-base--color--white-main t-base--align--center">{{priceInDayDiscount | localStr}} ₽/день</div>
                                    </div>
                                        ...
                                        <li class="v-indent v-indent--red" v-for="item in activeTarifs">
                                            <div class="price-item d-flex justify-content-between">
                                                ...
                                                <div class="price-item__cost">
                                                    <div class="price-item__cost-new t-base t-base--color--white-main">{{item.totalTarifPriceDiscount | localStr}} ₽</div>
                                                    <div class="price-item__cost-old t-base t-base--size--small t-base--line--through t-base--color--white-main" v-if="activeDays.discount > 0">{{item.totalTarifPrice | localStr}} ₽</div>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="price-item d-flex justify-content-between">
                                                <div class="price-item__descr">
                                                    ...
                                                    <div class="d-flex align-items-center t-base t-base--size--small t-base--color--white-main">
                                                        <div class="t-base t-base--size--xs t-base--color--white-main">{{licensePrice | localStr}} ₽</div>&nbsp;
                                                        &times;
                                                        &nbsp;
                                                ...
                                                <div class="price-item__cost">
                                                    <div class="price-item__cost-new t-base t-base--color--white-main">{{licensePriceDiscountCalc | localStr}} ₽</div>
                                                    <div class="price-item__cost-old t-base t-base--size--small t-base--line--through t-base--color--white-main" v-if="activeDays.discount > 0">{{licensePriceCalc | localStr}} ₽</div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="v-indent v-indent--red" v-if="diskSpaceCounter">
                                            <div class="price-item d-flex justify-content-between">
                                                <div class="price-item__descr">
                                                    ...
                                                    <div class="d-flex align-items-center t-base t-base--size--small t-base--color--white-main">
                                                        <div class="t-base t-base--size--xs t-base--color--white-main">{{storagePrice | localStr}} ₽</div>&nbsp;
                                                        &times;
                                                        &nbsp;
                                                ...
                                                <div class="price-item__cost">
                                                    <div class="price-item__cost-new t-base t-base--color--white-main">{{diskSpacePriceDiscountCalc | localStr}} ₽</div>
                                                    <div class="price-item__cost-old t-base t-base--size--small t-base--line--through t-base--color--white-main" v-if="activeDays.discount > 0">{{diskSpacePriceCalc | localStr}} ₽</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                    <button class="button-modern button-modern--w100p v-indent v-indent--yellow js-open-modal" :class="{'button-modern--theme--yellow': !integration}" type="button" data-commentary="Заявка с калькулятора RDV Маркет." data-request-type="3dd16968-1c80-4f63-9c59-635da55bb2d6" data-form="#form1" data-form-params='{"calculatorForm": true}'>Отправить заявку</button>
        ...
        <div v-if="mobilePrice" class="modal-price d-xs-none d-block" >
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button class="button-modern button-modern--lg button-modern--theme--yellow js-open-modal" type="button" data-form="#form1" data-commentary="Заявка с калькулятора RDV Маркет." data-request-type="3dd16968-1c80-4f63-9c59-635da55bb2d6" data-form-params='{"calculatorForm": true}'>Отправить заявку</button>
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            marketplaces: [
                {
                    logo: "assets/include/assets/img/marketplaces/logo-ozon-big.svg",
                    product: "ozone",
                    tarifs: [
                        {
                            name: "Ozon",
                ...
                {
                    logo: "assets/include/assets/img/marketplaces/logo-wildberries-big.svg",
                    product: "wildberries",
                    tarifs: [
                        {
                            name: "Wildberries",
                ...
                {
                    logo: "assets/include/assets/img/marketplaces/logo-sber-megamarket-big.svg",
                ...
                {
                    logo: "assets/include/assets/img/marketplaces/aliexpress-big.svg",
                    product: "aliexpress",
                    tarifs: [
                        {
                            name: "Aliexpress",
                ...
                {
                    logo: "assets/include/assets/img/marketplaces/logo-ya-market-big.svg",
    ...
    computed: {
        ...
        totalData() {
            ...
            str = `
              ...
              -----
              В тариф включено:
              ${this.activeTarifs.map(tarif => {	return `— ${tarif.name} (${tarif.code}) — ${tarif.totalTarifPriceDiscount.toLocaleString()} ₽`}).toString().replace(/,/g, "\n")}
              Пользовательские лицензии:
              ${this.licenseCounter} шт — ${this.licensePriceDiscountCalc.toLocaleString()} ₽
              Дополнительные модули:
              ${this.activeModules.map(module => {	return `— ${module.title} — ${module.totalTarifPriceDiscount.toLocaleString()} ₽`}).toString().replace(/,/g, "\n")}
